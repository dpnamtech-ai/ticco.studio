    ...
    <>
      ...
      <section className="relative z-10 md:overflow-x-clip bg-gradient-to-b from-[#e66107] to-[#803604] text-white px-6 md:px-0 pt-10 md:pt-[68px]">
        <div className="relative max-w-[1280px] mx-auto flex flex-col gap-8 md:block md:h-[780px]">
          ...
          <Reveal variant="mask" duration={1.1} className="md:absolute md:left-[490px] md:top-0">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/ve-tic-co/heading-ve-tic-co.png" alt="Về Tíc Cơ!" width={221} height={145} />
          </Reveal>
          <Reveal variant="left" delay={0.15} className="md:absolute md:left-0 md:bottom-0 md:w-[397px]">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/ve-tic-co/gioi-thieu-1.png" alt={aboutPage.intro[0]} className="w-full h-auto" />
          </Reveal>
          <Reveal variant="up" delay={0.3} className="md:absolute md:left-[397px] md:bottom-0 md:w-[420px]">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/ve-tic-co/gioi-thieu-2.png" alt={aboutPage.intro[1]} className="w-full h-auto" />
          </Reveal>
          <Reveal variant="right" delay={0.45} className="md:absolute md:left-[817px] md:bottom-0 md:w-[463px]">
            {/* eslint-disable-next-line @next/next/no-img-element */}
