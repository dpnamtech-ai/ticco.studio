    ...
    <>
      <section className="bg-[var(--color-orange)] text-white px-6 pt-16 pb-10 md:pt-24">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-4 items-end">
          <Reveal variant="mask" duration={1.4}>
          ...
          <Reveal variant="blur" delay={0.5} duration={1.2}>
      ...
      <Reveal variant="curtain" duration={1.6}>
      ...
      <section className="bg-[var(--color-orange)] text-white px-6 py-16">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <Reveal variant="blur" delay={0.15} duration={1.3}>
          ...
          <Reveal variant="blur" delay={0.3} duration={1.3}>
          <p className="leading-relaxed">
      ...
      <section className="bg-[var(--color-orange)] text-white px-6 pb-16">
        <div className="max-w-5xl mx-auto">
          <Reveal variant="blur" duration={1.2} className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Reveal key={item.image} variant="curtain" delay={i * 0.18} duration={1.3}>
                <div className="group">
                  <div className="relative aspect-[263/325] mb-4 overflow-hidden">
                    <Image src={item.image} alt={item.label} fill quality={90} sizes="(max-width: 768px) 100vw, 33vw" className="object-cover transition-transform duration-700 ease-out group-hover:scale-105" />
                  </div>
      ...
      <section className="bg-[#2c5242] text-white px-6 py-16">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <Reveal variant="left" duration={1.3}>
          ...
          <Reveal variant="curtain" delay={0.15} duration={1.4}>
      ...
      <section className="bg-[#2c5242] text-white px-6 pb-16">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <Reveal variant="curtain" duration={1.4} className="order-2 md:order-1">
            <div className="relative aspect-[210/263] max-w-xs mx-auto w-full">
              <Image
          ...
          <Reveal variant="right" delay={0.15} duration={1.3} className="order-1 md:order-2">
